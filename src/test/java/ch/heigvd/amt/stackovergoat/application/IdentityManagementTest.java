...
public class IdentityManagementTest {
    ...
    public class Authenticate {
        ...
        @Test
        public void shouldReturnCorrectUserDTOOnAuthenticate() throws AuthenticationFailedException {
        ...
        public void shouldNotAuthenticateWithWrongPassword() {
            ...
            assertThrows(AuthenticationFailedException.class, () -> identityManagementFacade.authenticate(authenticateCommand));
        }
    }
}
