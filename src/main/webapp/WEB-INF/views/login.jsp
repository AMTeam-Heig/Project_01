        ...
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="./login.do" method="POST">
                <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
                    ...
                    <input class="input100" type="text" name="username" id="login" class="form-control" placeholder="Identifiant">
                    <span class="focus-input100"></span>
                </div>

                <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
                    <span class="label-input100">Password</span>
                    <input class="input100" type="password" name="clearTextPassword" id="password" class="form-control"
